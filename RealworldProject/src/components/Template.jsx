...
const Template = ({ title, description1, description2, image, formType, setIsLoggedIn }) => {
  return (
    <div className="flex w-11/12 max-w-[1160px] p-12 mx-auto gap-y-0 gap-x-12 justify-between bg-black">
      ...
      <div className="relative w-11/12 max-w-[450px]">
        ...
        <img src={image} alt="main" width={558} height={504} loading="lazy" className="absolute -top-4 right-4" />
      </div>
    </div>
  );
};
